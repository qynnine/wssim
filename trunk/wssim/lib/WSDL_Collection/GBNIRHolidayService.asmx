...
<wsdl:definitions xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tns="http://www.27seconds.com/Holidays/GBNIR/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" targetNamespace="http://www.27seconds.com/Holidays/GBNIR/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://www.27seconds.com/Holidays/GBNIR/">
  ...
  <wsdl:portType name="GBNIRHolidayServiceSoap">
  ...
  <wsdl:portType name="GBNIRHolidayServiceHttpGet">
    <wsdl:operation name="GetHolidaysForDateRange">
      <documentation xmlns="http://schemas.xmlsoap.org/wsdl/">Get the holidays for a date range.</documentation>
  ...
  <wsdl:portType name="GBNIRHolidayServiceHttpPost">
    <wsdl:operation name="GetHolidaysForDateRange">
      <documentation xmlns="http://schemas.xmlsoap.org/wsdl/">Get the holidays for a date range.</documentation>
  ...
  <wsdl:binding name="GBNIRHolidayServiceSoap" type="tns:GBNIRHolidayServiceSoap">
    <soap:binding transport="http://schemas.xmlsoap.org/soap/http" style="document" />
    <wsdl:operation name="GetHolidaysForDateRange">
      <soap:operation soapAction="http://www.27seconds.com/Holidays/GBNIR/GetHolidaysForDateRange" style="document" />
      <wsdl:input>
    ...
    <wsdl:operation name="GetHolidaysForMonth">
      <soap:operation soapAction="http://www.27seconds.com/Holidays/GBNIR/GetHolidaysForMonth" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetHolidaysForYear">
      <soap:operation soapAction="http://www.27seconds.com/Holidays/GBNIR/GetHolidaysForYear" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetHolidayDate">
      <soap:operation soapAction="http://www.27seconds.com/Holidays/GBNIR/GetHolidayDate" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetHolidaysAvailable">
      <soap:operation soapAction="http://www.27seconds.com/Holidays/GBNIR/GetHolidaysAvailable" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="GBNIRHolidayServiceHttpGet" type="tns:GBNIRHolidayServiceHttpGet">
  ...
  <wsdl:binding name="GBNIRHolidayServiceHttpPost" type="tns:GBNIRHolidayServiceHttpPost">
  ...
  <wsdl:service name="GBNIRHolidayService">
    <documentation xmlns="http://schemas.xmlsoap.org/wsdl/">Web service that calculates national holidays for Northern Ireland (UK).</documentation>
    <wsdl:port name="GBNIRHolidayServiceSoap" binding="tns:GBNIRHolidayServiceSoap">
      <soap:address location="http://www.holidaywebservice.com/Holidays/GBNIR/GBNIRHolidayService.asmx" />
    </wsdl:port>
    <wsdl:port name="GBNIRHolidayServiceHttpGet" binding="tns:GBNIRHolidayServiceHttpGet">
      <http:address location="http://www.holidaywebservice.com/Holidays/GBNIR/GBNIRHolidayService.asmx" />
    </wsdl:port>
    <wsdl:port name="GBNIRHolidayServiceHttpPost" binding="tns:GBNIRHolidayServiceHttpPost">
      <http:address location="http://www.holidaywebservice.com/Holidays/GBNIR/GBNIRHolidayService.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>