...
public class IdentifierSimilarity2 {
	...
	public IdentifierSimilarity2 (String word1, String word2) {
	...
	public static void dumpSimilarity(String s1, String s2)
	{
		...
		IdentifierSimilarity2 idSim= new IdentifierSimilarity2(s1,s2);
		
		idSim.computeStructureSimilarity();
		structScore=idSim.getStructScore();
		
		System.out.print("\t StructSim: "+ structScore);
