...
public class WssimGUI extends JFrame{
	...
	private DefaultListModel<String> ws1OperlistModel,ws2OperListModel; 
	private DefaultListModel<String> ws1InMessageListModel,ws2InMessageListModel;
	private DefaultListModel<String> ws1OutMessageListModel,ws2OutMessageListModel; 
	...
	// for operation Panel
	private JComboBox<String> op1ComboBox;
	...
	JList<String> ws1OperationList, ws2OperationList; 
	JList<String> ws1InputMessageList, ws2InputMessageList;
	JList<String> ws1OutputMessageList, ws2OutputMessageList; 
	...
	JComboBox<String> Ws1_MessageListCBX = new JComboBox<String>();
	JComboBox<String> Ws2_MessageListCBX = new JComboBox<String>();
	...
	// elements in sf Pane 
	JComboBox<String> sfWs1_MessageListCBX = new JComboBox<String>();
	JComboBox<String> sfWs2_MessageListCBX = new JComboBox<String>();
	
	JComboBox<String> sfForumlaCBX = new JComboBox<String>();
	JComboBox<String> sfFlowGraphTypeCBX = new JComboBox<String>();
	...
	private void populateOpPanel(JPanel opPanel) {
		...
		op1ComboBox = new JComboBox<String>();
		...
		ws1OperlistModel = new DefaultListModel<String>();
		ws2OperListModel = new DefaultListModel<String>();
		ws1OperationList = new JList<String>(ws1OperlistModel);
		...
		ws2OperationList = new JList<String>(ws2OperListModel);
	...
	private void populateMsPanel (JPanel msPanel){
		...
		ws1InMessageListModel = new DefaultListModel<String>();
		ws2InMessageListModel= new DefaultListModel<String>();
		
		ws1InputMessageList = new JList<String>(ws1InMessageListModel);
		...
		ws2InputMessageList= new JList<String>(ws2InMessageListModel);
		...
		ws1OutMessageListModel = new DefaultListModel<String>();
		ws2OutMessageListModel= new DefaultListModel<String>();
		
		ws1OutputMessageList = new JList<String>(ws1OutMessageListModel);
		...
		ws2OutputMessageList = new JList<String>(ws2OutMessageListModel);
