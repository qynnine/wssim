...
<wsdl:definitions xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://ws.eoddata.com/Data" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" targetNamespace="http://ws.eoddata.com/Data" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  ...
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://ws.eoddata.com/Data">
      ...
      <s:complexType name="TECHNICAL">
        ...
        <s:attribute name="AvgYearVolumne" type="s:double" use="required" />
  ...
  <wsdl:portType name="DataSoap">
    ...
    <wsdl:operation name="QuoteList2">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Returns end of day quotes for a list of symbols of a specific exchange.&lt;br/&gt;INPUT: Token (Login Token), Exchange (eg: NASDAQ), Symbols (eg:MSFT,INTC)&lt;br/&gt;OUTPUT: List of end of day quotes</wsdl:documentation>
  ...
  <wsdl:service name="Data">
    ...
    <wsdl:port name="DataSoap" binding="tns:DataSoap">
      <soap:address location="http://ws.eoddata.com/EndOfDay.asmx" />
    </wsdl:port>
    <wsdl:port name="DataSoap12" binding="tns:DataSoap12">
      <soap12:address location="http://ws.eoddata.com/EndOfDay.asmx" />
    </wsdl:port>
    <wsdl:port name="DataHttpGet" binding="tns:DataHttpGet">
      <http:address location="http://ws.eoddata.com/EndOfDay.asmx" />
    </wsdl:port>
